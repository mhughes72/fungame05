...
Each option defines:
  ...
  economy_effects   – deterministic economy sub-stat deltas (stock_market, unemployment,
                      consumer_prices, budget_deficit)
...
Economy sub-stat directions:
  stock_market:    high = good  (+X improves markets)
  unemployment:    high = bad   (+X means more joblessness)
  consumer_prices: high = bad   (+X means higher prices)
  budget_deficit:  high = bad   (+X means larger deficit)
"""
        ...
        "options": [
            {
                ...
                "stat_effects":    {"unrest": -10, "public_trust": 5},
                "economy_effects": {"consumer_prices": -8, "budget_deficit": 12},
            ...
            },
            {
                ...
                "economy_effects": {"budget_deficit": 2},
            ...
            },
            {
                ...
                "economy_effects": {"consumer_prices": -2},
        ...
        "options": [
            {
                ...
                "stat_effects":    {"international_reputation": 4},
                "economy_effects": {"stock_market": 8, "budget_deficit": 8},
            ...
            },
            {
                ...
                "stat_effects":    {"institutional_strength": -4},
                "economy_effects": {"stock_market": 5, "unemployment": -3},
            ...
            },
            {
                ...
                "stat_effects":    {"international_reputation": -6},
                "economy_effects": {"stock_market": -8, "unemployment": 4},
        ...
        "options": [
            {
                ...
                "stat_effects":    {"public_trust": 8, "institutional_strength": 6},
        ...
        "options": [
            {
                ...
                "stat_effects":    {"unrest": -8},
                "economy_effects": {"consumer_prices": -6, "budget_deficit": 10},
            ...
            },
            {
                ...
                "stat_effects":    {"unrest": -5},
                "economy_effects": {"consumer_prices": -8, "budget_deficit": 5, "stock_market": -3},
    ...
    # ── 6 ─────────────────────────────────────────────────────────────────────
    {
        ...
        "options": [
            ...
            },
            {
                ...
                "stat_effects":    {"unrest": 5, "international_reputation": -5},
                "economy_effects": {"stock_market": -5, "budget_deficit": 4},
            ...
            },
            {
                ...
                "stat_effects":    {"international_reputation": 2},
                "economy_effects": {"stock_market": -5, "budget_deficit": 4, "unemployment": 3},
        ...
        "options": [
            {
                ...
                "stat_effects":    {"unrest": -8, "public_trust": 4},
                "economy_effects": {"budget_deficit": 12, "consumer_prices": -2},
            ...
            },
            {
                ...
                "economy_effects": {"unemployment": 3},
            ...
            },
            {
                ...
                "stat_effects":    {"unrest": 8, "public_trust": -4},
                "economy_effects": {"stock_market": -5, "unemployment": 4},
        ...
        "options": [
            {
                ...
                "stat_effects":    {"international_reputation": 7, "unrest": 6},
                "economy_effects": {"budget_deficit": -10, "stock_market": 5, "unemployment": 5, "consumer_prices": 4},
            ...
            },
            {
                ...
                "stat_effects":    {"international_reputation": 3, "unrest": 3},
                "economy_effects": {"budget_deficit": -5, "stock_market": 3, "unemployment": 2},
            ...
            },
            {
                ...
                "stat_effects":    {"international_reputation": -7},
                "economy_effects": {"budget_deficit": 5, "stock_market": -5},
            ...
            {
                "label": "Reject publicly while secretly continuing negotiations",
        ...
        "options": [
            {
                ...
                "stat_effects":    {"unrest": -6, "public_trust": 5},
                "economy_effects": {"consumer_prices": -6, "stock_market": -4},
            ...
            },
            {
                ...
                "stat_effects":    {"public_trust": 4},
                "economy_effects": {"budget_deficit": 10, "unemployment": -4, "consumer_prices": -2},
            ...
            },
            {
                ...
                "stat_effects":    {"unrest": -4, "public_trust": 2},
            ...
            },
            {
                ...
                "economy_effects": {"stock_market": 4, "unemployment": -3},
