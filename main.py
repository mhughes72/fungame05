...
if "--mode" in sys.argv:
    ...
    if _mode not in ("classic", "freeform", "campaign"):
        print(f"Error: unknown mode '{_mode}'. Available: classic, freeform, campaign")
        sys.exit(1)
...
if _mode == "freeform":
    ...
    from graph.campaign_graph import pre_campaign_graph, post_campaign_graph
else:
...
def run_game() -> None:
    ...
    if _mode == "freeform":
        ...
        console.print(
            "  [dim italic]Campaign mode — a scripted year in the Republic of Veridia. "
            "Your choices accumulate. Month 8 shows you who you've been.[/dim italic]\n"
        )
